...
public class PassordUtil {
	 ...
	 */
	public static boolean validerMedSalt(String passord, String salt, String hash) {
	...
	public static String finnHash(String passord) {
        return passord.substring(0, 63);
    }
	
	public static String finnSalt(String passord) {
        return passord.substring(64, 95);
    }
}